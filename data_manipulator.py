...
class DataManipulator:
    ...
    def __init__(self, master_array, combined_revenue, modules, run_option, companies, strategies, date_range_from, date_range_to):
        ...
        self.__combined_revenue = combined_revenue
    ...
    def strategy_company_data_len(self, strategy, company):
        if company not in self.__master_array[strategy].keys():
            return 0
        else:
